...
export default function BookInfoSection({
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div data-error={!!errors.title}>
          ...
          <input
            ...
            } focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:text-white shadow-sm`}
  ...
  className={`w-full px-4 py-2.5 rounded-lg border ${
    errors.state
      ? "border-red-500 bg-red-50 dark:bg-red-900/10"
      : "border-gray-300 dark:border-gray-600 dark:bg-gray-700"
  } focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:text-white shadow-sm appearance-none bg-no-repeat`}
  style={{
          ...
          <input
            ...
            className={`w-full px-4 py-2.5 rounded-lg border ${
              errors.price
                ? "border-red-500 bg-red-50 dark:bg-red-900/10"
                : "border-gray-300 dark:border-gray-600 dark:bg-gray-700"
            } focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:text-white shadow-sm pr-10`}
            placeholder="0.00"
          />
